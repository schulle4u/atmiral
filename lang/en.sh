...
UI_FM_NO_SELECTION="No selection"
...
ACTION_TITLE="%s: %s"
ACTION_OPEN_DIR="Open directory"
ACTION_AS_TEXT="Open with %s as text"
ACTION_VIEW="View with %s"
ACTION_PLAY_MEDIA="Play with %s"
ACTION_IMAGE="View with %s"
ACTION_RUN="Run"
ACTION_CUSTOM="Open with"
ACTION_COPY="Copy to"
ACTION_MOVE="Move to"
ACTION_DELETE="Delete"
ACTION_DELETE_CONFIRM="Should %s '%s' be deleted?"
ACTION_INFO="File info"
